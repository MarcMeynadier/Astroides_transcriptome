...
dataPath<-'/data/net/5_kallisto/adultTranscriptome/juvenile'
...
write.csv(resOrderedDF_sp_VS_gm, file = paste(scriptPath,'/data/net/6_deseq2/adultTranscriptome/juvenile/DESeq2_results_juvenile_sp_VS_gm.csv',sep=''))
write.csv(resOrderedDF_ext_VS_amb, file = paste(scriptPath,'/data/net/6_deseq2/adultTranscriptome/juvenile/DESeq2_results_juvenile_ext_VS_amb.csv',sep=''))
write.csv(resOrderedDF_low_VS_amb, file = paste(scriptPath,'/data/net/6_deseq2/adultTranscriptome/juvenile/DESeq2_results_juvenile_low_VS_amb.csv',sep=''))
write.csv(resOrderedDF_low_VS_ext, file = paste(scriptPath,'/data/net/6_deseq2/adultTranscriptome/juvenile/DESeq2_results_juvenile_low_VS_ext.csv',sep=''))
write.csv(resOrderedDF_sp_amb_VS_gm_low_natSim, file = paste(scriptPath,'/data/net/6_deseq2/adultTranscriptome/juvenile/DESeq2_results_juvenile_sp_amb_VS_gm_low_natSim.csv',sep=''))
