...
packageCheckClassic(c('DESeq2','devtools','BiocManager','ggplot2','ggrepel','markdown','airway'))
...
dataPath<-'/data/net/5_kallisto/adultTranscriptome/adult/nov2016'
...
txi<-tximport(files = files,type='kallisto', tx2gene = paste(scriptPath,'/data/net/5_kallisto/tx2gene',sep=''),txOut=T)
...
write.csv(resOrderedDF_gm_pv, file = paste(scriptPath,'/data/net/6_deseq2/adult/1_preliminarySamples/DESeq2_results_adultTranscriptome_adultTranscriptome_nov2016_gm_VS_pv.csv',sep=''))
