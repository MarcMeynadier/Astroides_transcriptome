...
scriptPath <- sub("/[^/]+$", "", scriptPath)
dataPath<-'/data/net/6_kallisto/adultTranscriptome/adult/2_spatialComparison'
...
write.csv(resOrderedDF_pv_VS_gm_paired, file = paste(scriptPath,'/data/net/7_deseq2/larvaeJuvenileAdultTranscriptome/adult/DESeq2_results_adult_spatialComparison_pv_VS_gm_paired.csv',sep=''))
write.csv(resOrderedDF_sa_VS_gm_paired, file = paste(scriptPath,'/data/net/7_deseq2/larvaeJuvenileAdultTranscriptome/adult/DESeq2_results_adult_spatialComparison_sa_VS_gm_paired.csv',sep=''))
write.csv(resOrderedDF_sp_VS_gm_paired, file = paste(scriptPath,'/data/net/7_deseq2/larvaeJuvenileAdultTranscriptome/adult/DESeq2_results_adult_spatialComparison_sp_VS_gm_paired.csv',sep=''))
write.csv(resOrderedDF_tro_VS_bck_paired, file = paste(scriptPath,'/data/net/7_deseq2/larvaeJuvenileAdultTranscriptome/adult/DESeq2_results_adult_spatialComparison_tro_VS_bck_paired.csv',sep=''))
write.csv(resOrderedDF_pv_VS_gm_single, file = paste(scriptPath,'/data/net/7_deseq2/larvaeJuvenileAdultTranscriptome/adult/DESeq2_results_adult_spatialComparison_pv_VS_gm_single.csv',sep=''))
write.csv(resOrderedDF_sp_VS_gm_single, file = paste(scriptPath,'/data/net/7_deseq2/larvaeJuvenileAdultTranscriptome/adult/DESeq2_results_adult_spatialComparison_sp_VS_gm_single.csv',sep=''))
write.csv(resOrderedDF_tro_VS_bck_single, file = paste(scriptPath,'/data/net/7_deseq2/larvaeJuvenileAdultTranscriptome/adult/DESeq2_results_adult_spatialComparison_tro_VS_bck_single.csv',sep=''))
write.csv(resOrderedDF_pv_VS_gm, file = paste(scriptPath,'/data/net/7_deseq2/larvaeJuvenileAdultTranscriptome/adult/DESeq2_results_adult_spatialComparison_pv_VS_gm.csv',sep=''))
write.csv(resOrderedDF_sa_VS_gm, file = paste(scriptPath,'/data/net/7_deseq2/larvaeJuvenileAdultTranscriptome/adult/DESeq2_results_adult_spatialComparison_sa_VS_gm.csv',sep=''))
write.csv(resOrderedDF_sp_VS_gm, file = paste(scriptPath,'/data/net/7_deseq2/larvaeJuvenileAdultTranscriptome/adult/DESeq2_results_adult_spatialComparison_sp_VS_gm.csv',sep=''))
write.csv(resOrderedDF_tro_VS_bck, file = paste(scriptPath,'/data/net/7_deseq2/larvaeJuvenileAdultTranscriptome/adult/DESeq2_results_adult_spatialComparison_tro_VS_bck.csv',sep=''))
